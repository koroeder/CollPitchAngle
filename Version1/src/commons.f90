MODULE COMMONS
   ...
   INTEGER :: NMETHPRO = 0
   INTEGER, ALLOCATABLE :: METH_PRO_GROUPS(:,:)
   INTEGER :: NMETHHYP = 0
   INTEGER, ALLOCATABLE :: METH_HYP_GROUPS(:,:)

   !> pitch angle for peptides
   REAL(KIND=REAL64), ALLOCATABLE :: PEPANGLES(:,:)
   !> pitch angles for methylene groups
   REAL(KIND=REAL64), ALLOCATABLE :: METH_PRO_ANGLES(:,:)
   REAL(KIND=REAL64), ALLOCATABLE :: METH_HYP_ANGLES(:,:)

   ! only one group of methylene groups
